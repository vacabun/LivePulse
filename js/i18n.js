...
export const translations = {
  zh: {
    ...
    myRouteTitleAll: '切换：显示全部活动排程',

    // Meta Stats
    statCurrentEvents: '当前排程:',
    statTotal: '总计:',
    statStarred: '已标记参加:',
    statFestivals: '演出活动:',
    ...
    emptyEventsDesc: '点击上方推荐模版快速体验，或打开模版库粘贴通知文本智能识别排程！',
    ...
    storageDesc: '已收录 {festivals} 场演出活动，共 {events} 条排程（约占用 {sizeKB} KB 空间）',
    ...
    importModeMerge: '合并追加（保留现有日程，追加新活动排程）',
    ...
    templateModalSubtitle: '选择精选活动模版或直接粘贴官方排程通知文本',
...
13:55〜15:25 終演後物販・特典会`,
    parsedPreviewTitle: '解析结果预览 ({count} 项排程)',
    ...
    labelEventDesc: '排程备注 (限定周边/曲目/注意事项)',
    ...
    toastImportSuccess: '成功导入 {count} 条排程！',
    toastImportTemplateSuccess: '已成功导入模版「{name}」，共 {count} 条排程！',
    toastExportIcs: '个人活动日历 (.ics) 已生成！可直接导入手机/系统日历',
    toastExportJson: 'JSON 备份文件已导出！',
    toastAllCleared: '所有本地排程已清空',
    toastEventSaved: '排程保存成功！',
    toastEventDeleted: '排程已删除',
    toastFestivalDeleted: '活动已删除',
    toastSwitchStarred: '已切换至【我的活动路线】模式',
    toastSwitchAll: '已显示【全部活动排程】',
    confirmClearAll: '【危险操作】确定要清空所有本地日程数据吗？此操作无法撤销。',
    confirmDeleteEvent: '确定要删除该排程吗？',
    confirmDeleteFestival: '确定要删除活动「{name}」及其所有排程吗？',
    allDay: '全天'
  },
  ...
  en: {
    ...
    btnUploadJson: 'Upload JSON File',
...
13:55〜15:25 終演後物販・特典会`,
    ...
    toastExportIcs: 'Personal calendar (.ics) generated! Ready for iPhone/Google Calendar sync',
  ...
  ja: {
    ...
    exportJsonTitle: 'JSON フルバックアップ出力',
    exportJsonDesc: '全イベント・出演者・参加チェック状態を含む完全バックアップ',
    exportIcsTitle: 'iCal (.ics) カレンダー出力',
    exportIcsDesc: 'iPhone / Mac / Google カレンダーに取り込んで出演通知アラームを設定',
    importCardTitle: 'データ復元 (JSON)',
...
13:55〜15:25 終演後物販・特典会`,
    ...
    toastExportIcs: 'iCal (.ics) カレンダーを出力しました！スマホのカレンダーに登録できます',
    toastExportJson: 'JSON バックアップを出力しました！',
    toastAllCleared: '全データを削除しました',
...
13:55〜15:25 終演後物販・特典会`,
    ...
    toastExportIcs: '개인 캘린더 (.ics) 파일이 생성되었습니다! 스마트폰 캘린더에 연동하세요',
